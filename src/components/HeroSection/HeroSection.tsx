...
async function HeroSection() {
  ...
  return (
    <main className="flex justify-center min-h-[690px] w-full bg-primary">
      <div className="  flex max-w-[90rem] flex-wrap justify-center md:justify-between  p-6 items-center relative top-0  ">
        <div className="w-full md:w-1/2 mt-32 md:mt-14 flex flex-col gap-2   ">
          ...
          <Link href="https://youtu.be/cGcjsvUxzbE?feature=shared">
            <button className="flex justify-center items-center  text-white bg-secondary opacity-90 hover:opacity-100 hover:transition-all hover:ease-in-out hover:delay-70 hover:duration-300 w-fit py-1 px-4 xs:px-6 md:px-10 rounded-full max-w-[200px] w-fit ">
