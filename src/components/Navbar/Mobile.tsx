...
function Mobile() {
  ...
  return (
    <nav className='w-full min-h-[80px] bg-primary md:hidden justify-between items-center fixed top-0 z-10 '> 
      ...
      <div className=' relative top-4 left-4 shrink-0 overflow-x-hidden '>
        <Image src={PanaverseLogo} alt='Panaverse DAO Logo' height={400} width={400}
  ...
  <div  className={`flex flex-col justify-center items-center absolute border-t-4 bg-inherit p-4 ${open ? 'top-20' :'top-[-490px]'}  z-[-1] pb-12 w-full transition-all duration-500 ease-in`}>
